...
def analyze_glucose_final_v3():
    ...
    try:
        ...
        print(f"Weekly Average: {weekly_avg:.2f} mmol/L")
        ...
        # *** NEW: SHOW AVERAGE NUMBER ON THE LINE ***
        # Display text at the rightmost edge of the chart
        ...
        # *** NEW: SET Y-AXIS LIMIT 3 - 11.5 ***
        ax1.set_ylim(3, 11.5)

        ax1.set_title(f'7-Day Glucose Trends (Hourly Avg)', fontsize=14, fontweight='bold')
        ...
        ax2.set_title('Daily Summary (Raw Data)', fontsize=12, fontweight='bold')
        ...
        output_filename = f"Glucose_Report_Final_{s_str}_to_{e_str}.png"
